...
namespace PTPM_HTQLNH_SHARE.Models
{
    ...
    public partial class BTLPTPM_RES_DBEntities : DbContext
    {
        public BTLPTPM_RES_DBEntities()
            : base("name=BTLPTPM_RES_DBEntities")
        {
        }
        ...
        public virtual DbSet<User_Restaurant> User_Restaurant { get; set; }
